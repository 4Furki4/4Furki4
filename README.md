...
Skills: C# / .NET Core/ Unity / HTML / CSS 

- 🌱 I’m currently learning C#, .Net Core (Web Applications and APIs) and Unity(for fun), learned HTML(basic), CSS(basic) and somewhat SQL.
